...
func testClientServer() (*Multiplex, *Multiplex) {
	return testClientServerConfig()
}

func testClientServerConfig() (*Multiplex, *Multiplex) {
	conn1, conn2 := testConn()
	client := NewMultiplex(conn1, true)
	server := NewMultiplex(conn2, false)
